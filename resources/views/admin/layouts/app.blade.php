...
<html lang="en">
  ...
  <body>
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{ route('create') }}">
              ...
              <span class="menu-title">Create Teacher-Module</span>
            </a>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" href="{{ route('index') }}">
              ...
              <span class="menu-title">Show Teacher-module</span>
            </a>
          </li>
    ...
    <!-- container-scroller -->
    <!-- plugins:js -->
    <script src="{{ asset('admin/assets/vendors/js/vendor.bundle.base.js"></scrip') }}t>
    <!-- endinject -->
    <!-- Plugin js for this page -->
    <script src="{{ asset('admin/assets/vendors/chart.js/Chart.min.js"></scrip') }}t>
    <script src="{{ asset('admin/assets/vendors/progressbar.js/progressbar.min.js"></scrip') }}t>
    <script src="{{ asset('admin/assets/vendors/jvectormap/jquery-jvectormap.min.js"></scrip') }}t>
    <script src="{{ asset('admin/assets/vendors/jvectormap/jquery-jvectormap-world-mill-en.js"></scrip') }}t>
    <script src="{{ asset('admin/assets/vendors/owl-carousel-2/owl.carousel.min.js"></scrip') }}t>
    <!-- End plugin js for this page -->
    <!-- inject:js -->
    <script src="{{ asset('admin/assets/js/off-canvas.js"></scrip') }}t>
    <script src="{{ asset('admin/assets/js/hoverable-collapse.js"></scrip') }}t>
    <script src="{{ asset('admin/assets/js/misc.js"></scrip') }}t>
    <script src="{{ asset('admin/assets/js/settings.js"></scrip') }}t>
    <script src="{{ asset('admin/assets/js/todolist.js"></scrip') }}t>
    <!-- endinject -->
    <!-- Custom js for this page -->
    <script src="{{ asset('admin/assets/js/dashboard.js"></scrip') }}t>
